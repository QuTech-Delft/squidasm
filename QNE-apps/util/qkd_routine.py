...
class QKDRoutine:
    ...
    @classmethod
    def run(
        cls, context: ProgramContext, peer_name: str, is_init: bool,
            num_epr: int, num_test_bits: int = None
        ...
        pairs_info = yield from cls._distribute_states(context, is_init, peer_name, num_epr)
