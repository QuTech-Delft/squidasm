...
from netsquid_magic.photonic_interface_interface import IPhotonicInterface, IPhotonicInterfaceConfig, IPhotonicInterfaceBuilder
...
class DepolarizingPhotonicInterface(IPhotonicInterface):
    ...
    def operate(self, state: QRepr) -> QRepr:
        ...
        return DenseDMRepr(num_qubits=state.num_qubits,
...
class DepolarizingPhotonicInterfaceBuilder(IPhotonicInterfaceBuilder):
    ...
    def build(
        ...
        if not isinstance(photonic_interface_cfg, DepolarizingPhotonicInterfaceConfig):
            raise TypeError(f"Expected type: {DepolarizingPhotonicInterfaceConfig}"
