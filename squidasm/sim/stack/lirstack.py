...
from squidasm.sim.stack.lirruntime import LirRuntime, LirRuntimeComponent
...
class ProcessingNode(Node):
    ...
    stack consisting of LirRuntime, QNodeOS and QDevice.

    This component has two subcomponents: a QnosComponent and a LirRuntimeComponent.

    Has communications ports between
     - the LirRuntime component on this node and the LirRuntime component on the peer node
    ...
    def __init__(
        ...
        host_comp = LirRuntimeComponent(self)
    ...
    @property
    def host_comp(self) -> LirRuntimeComponent:
...
class NodeStack(Protocol):
    ...
    The software stack consists of a LirRuntime, QNodeOS and a QDevice.
    The LirRuntime and QNodeOS are each represented by separate subprotocols.
    ...
    def __init__(
        ...
        :param use_default_components: whether to automatically create NetSquid
            components for the LirRuntime and QNodeOS, defaults to True. If False,
        ...
        self._host: Optional[LirRuntime] = None
        ...
        if use_default_components:
            self._host = LirRuntime(self.host_comp, qdevice_type)
    ...
    @property
    def host(self) -> LirRuntime:
        return self._host

    @host.setter
    def host(self, host: LirRuntime) -> None:
        self._host = host
